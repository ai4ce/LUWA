...
if __name__ == '__main__':
    ...
    classes_num = 6
    BATCHSIZE = 100
    train_dataset = TribologyDataset(input_path, split='train_hm') #  transform=TrainTransform
    valid_dataset = TribologyDataset(input_path, split='eval_hm')
    test_dataset = TribologyDataset(input_path, split='test_hm')
    ...
    lr_fig_path = f'./lr-finder-ResNet50_hm.pdf'
    ...
    for epoch in range(EPOCHS):
        ...
        if valid_loss < best_valid_loss:
            ...
            # Saving the model
            save_path = f'./model-ResNet50_hm.pth'
    ...
    cm_fig_path = f'./confusion-matrix-ResNet50_hm.pdf'
    ...
    pca_path = f'./output-pca-ResNet50_hm.pdf'
    ...
    filtered_image_path = f'./output-filtered-image-ResNet50_hm.pdf'
    plot_filtered_images(filtered_image_path, images, filters, N_FILTERS)

    filters_path = f'./output-filters-ResNet50_hm.pdf'
    plot_filters(filters_path, filters)

    tsne_fig_path = f'./output-tsne-ResNet50_hm.pdf'
    plot_dataloader_tsne(tsne_fig_path, test_iterator)

    # Grad-CAM
    grad_cam_path = f'./output-gradcam-ResNet50_hm.pdf'
