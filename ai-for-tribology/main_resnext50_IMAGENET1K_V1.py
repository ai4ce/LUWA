...
if __name__ == '__main__':
    ...
    # Define model 
    model = resnext50_32x4d(weights='IMAGENET1K_V1', progress=True)
    ...
    lr_fig_path = f'./lr-finder-ResNext50-IMAGENET1K_V1.pdf'
    ...
    for epoch in range(EPOCHS):
        ...
        if valid_loss < best_valid_loss:
            ...
            # Saving the model
            save_path = f'./model-fold-ResNext50-IMAGENET1K_V1.pth'
    ...
    cm_fig_path = f'./confusion-matrix-ResNext50-IMAGENET1K_V1.pdf'
    ...
    pca_path = f'./output-pca-ResNext50-IMAGENET1K_V1.pdf'
    ...
    filtered_image_path = f'./output-filtered-image-ResNext50-IMAGENET1K_V1.pdf'
    plot_filtered_images(filtered_image_path, images, filters, N_FILTERS)

    filters_path = f'./output-filters-ResNext50-IMAGENET1K_V1.pdf'
